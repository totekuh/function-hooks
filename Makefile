...
$(LIB_DIR)/common.o: $(SRC_DIR)/common.c $(SRC_DIR)/common.h
	$(CC) $(CFLAGS) -c $(SRC_DIR)/common.c -o $(LIB_DIR)/common.o

$(LIB_DIR)/recvmsg.o: $(SRC_DIR)/recvmsg.c
	$(CC) $(CFLAGS) -c $(SRC_DIR)/recvmsg.c -o $(LIB_DIR)/recvmsg.o

$(LIB_DIR)/recvfrom.o: $(SRC_DIR)/recvfrom.c
	$(CC) $(CFLAGS) -c $(SRC_DIR)/recvfrom.c -o $(LIB_DIR)/recvfrom.o

$(LIB_DIR)/memcpy.o: $(SRC_DIR)/memcpy.c
	$(CC) $(CFLAGS) -c $(SRC_DIR)/memcpy.c -o $(LIB_DIR)/memcpy.o

$(LIB_DIR)/hooks.so: $(LIB_DIR)/common.o $(LIB_DIR)/recvmsg.o $(LIB_DIR)/recvfrom.o $(LIB_DIR)/memcpy.o
	$(CC) $(LDFLAGS) -o $(LIB_DIR)/hooks.so $(LIB_DIR)/common.o $(LIB_DIR)/recvmsg.o $(LIB_DIR)/recvfrom.o $(LIB_DIR)/memcpy.o -ldl
